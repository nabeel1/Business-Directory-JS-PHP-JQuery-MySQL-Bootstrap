...
$resp=mysql_query("SELECT * FROM property WHERE city='$c' and Active='1' ORDER BY id DESC");
$num_rows=MYSQL_NUM_ROWS($resp);

$title="Find and buy a property for sale & rent in ".$c;
$mkeyword=$c." properties, buy property in ".$c.", sale property ".$c.", find ".$c." properties";
$mdesc="Find a property in ".$c.". Buy & sale properties in ".$c.". Rent a house, house flat, commerical offices in ".$c;
...
<font color="#DDDDDD">You are Here: <a href="../../../index.php">Home</a> > <a href="../../<?php echo $city_rep; ?>"> <?php echo $first_city_cap; ?> City Directory</a> > Local <?php echo $c;?> Properties</font>
</div>
