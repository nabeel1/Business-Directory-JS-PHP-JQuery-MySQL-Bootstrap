...
<link type="text/css" rel="stylesheet" href="../../datepicker/demos.css">
...
$resp=mysql_query("SELECT * FROM event WHERE city='$c' and Active='1' ORDER BY id DESC");
$num_rows=MYSQL_NUM_ROWS($resp);

$title="Upcoming ".$c." Events, Local ".$c." Event calender";
$mkeyword=$c." Events, local ".$c." events, upcoming ".$c." calendar, latest events in ".$c;
$mdesc="Local ".$c." upcoming events calendar. Check out latest ".$c." events. share & promote ".$c." events with us.";
?>
...
<font color="#DDDDDD">You are Here: <a href="../../../index.php">Home</a> > <a href="../../<?php echo $city_rep; ?>"> <?php echo $first_city_cap; ?> City Directory</a> > Local <?php echo $c;?> Event</font>
</div>
