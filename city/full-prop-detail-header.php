...
$resp=mysql_query("SELECT * FROM property WHERE id='$p_id'");
$num_rows=MYSQL_NUM_ROWS($resp);

$category_p=mysql_result($resp,0,"category");
$type=mysql_result($resp,0,"type");
$address=mysql_result($resp,0,"address");
$town=mysql_result($resp,0,"town");
$city1=mysql_result($resp,0,"city");
$code=mysql_result($resp,0,"code");
$bedrooms=mysql_result($resp,0,"bedrooms");
$price=mysql_result($resp,0,"price");
$image_url=mysql_result($resp,0,"image_url");
$name1=mysql_result($resp,0,"name1");
$number=mysql_result($resp,0,"number");
$pdesc=mysql_result($resp,0,"pdesc");
$ptitle=mysql_result($resp,0,"title");

$title="Buy and sell property in ".$c."-".$ptitle;
$mkeyword="Find property in ".$c.", ".$ptitle." in ".$c;
$mdesc="Find property in ".$c.". ".$ptitle." in ".$c.". ".substr($pdesc,0,60);
...
<font color="#DDDDDD">You are Here: <a href="../../../index.php">Home</a> > <a href="../../<?php echo $city_rep; ?>"> <?php echo $first_city_cap; ?> City Directory</a> > Local <?php echo $c;?> properties</font> <font color="#DDDDDD"> > <?php echo $ptitle;?> </font>  
</div>
