...
$res=mysql_query("SELECT * FROM tblindustries ORDER BY id Desc");
...
<td width="230px"><font color="#009900">Sub-Category Name</font> </td>
...
<td width='150px'><a href='edit-sub.php?id=$id'>Edit This Category</a> </td>
<td width='150px'><a href='delete-sub-category.php?id=$id'>Delete This Category</a> </td>
</tr>";
