...
$sMetaTitle=mysql_result($resb,0,"sMetaTitle");
$sMetaKeywords=mysql_result($resb,0,"sMetaKeywords");
$sMetaDescription=mysql_result($resb,0,"sMetaDescription");

?>

<table align="center" width="430px">
<form action="edit-listing-pro.php" method="post">
...
<td><input type="text" id="title" name="title" size="60" value="<?php echo $sMetaTitle;?>" ></td>
</tr>

<tr height="40px"><td>Meta Description : </td>
<td><textarea name="mdesc" id="mdesc" cols="40" rows="6"><?php echo $sMetaDescription;?></textarea></td>
</tr>

<tr height="40px"><td>meta Keyword : </td>
<td><textarea name="keyword" id="keyword" cols="40" rows="6"><?php echo $sMetaKeywords;?></textarea></td>
</tr>
...
<td><input type="submit" name="submit" value="EDIT Your Business" /></td>
</tr>
