...
@$c=mysql_result($res_u,0,"city");

$title="Profile of ".$fname." ".$lname." in ".$c.", Businesses ".$fname." ".$lname;
$mdesc="profile of ".$fname." ".$lname." in ".$c.". ".$fname." ".$lname." businesses, local photos, properties, local events in ".$c.".";
$mkeyword="profile of ".$fname." ".$lname.", ".$c." ".$fname." ".$lname." businesses, local photos of ".$fname." ".$lname.", events ".$fname." ".$lname.", properties";
?>

<title><?php echo $title;?></title>
<meta name="description" content="<?php echo $mdesc; ?>" /> 
<meta name="<?php echo $mkeyword;?>" /> 
...
<font color="#DDDDDD">You are Here: <a href="http://<?php echo $_SERVER['SERVER_NAME'];?>">Home</a> > <a href="../../city/<?php echo $city_rep; ?>"> <?php echo $first_city_cap; ?> </a> > <?php echo $fname." ".$lname; ?> Member Area</font>
</div>
