...
<center><h1><font color="#32A4D5">Thanks for submitting event !!</font></h1></center>

<font color="#EE0000">You can view your event on <?php echo $c;?> event page / section.</font>
...
if($city!="-1")
{
 ...
 $status="open";
 $pp="no.jpg";
mysql_query("INSERT INTO event (category,start,end,event_name,event_desc,city,contact_name,contact_num,image_url,Active,e_email,e_address) VALUES ('$category','$today_start','$end_start','$event_name','$event_desc','$city','$name1','$number','$pp','1','$event_email','$event_address')");
 echo "<center><font size='+1' color='#40AB05'>Your EVENT Added Succesffully </font></center>";
 }
 else if($data!="")
 {
 $status="open";
mysql_query("INSERT INTO event (category,start,end,event_name,event_desc,city,contact_name,contact_num,image_url,Active,e_email,e_address) VALUES ('$category','$today_start','$end_start','$event_name','$event_desc','$city','$name1','$number','$name','1','$event_email','$event_address')");
...
$message="Approve or disapprove new event request";
