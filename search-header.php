...
@$res=mysql_query("SELECT * FROM city WHERE city='$lcity'");
$num_rows_c=MYSQL_NUM_ROWS($res);
...
echo "alert('City in which you want to search is not Foundt. Try Another City')";
echo "</script>";
...
$title="Search result for ".$bname." ".$first_city_cap.", Find ".$bname." in ".$first_city_cap;
$keyword="Businesses ".$bname." ".$first_city_cap.", Search for ".$bname." in ".$first_city_cap.", Find ".$bname." Local Listings";
$mdesc="Searches for ".$bname." Businesses in ".$first_city_cap.". Find local listings ".$bname. " in ".$first_city_cap." Business directory";
?>
...
<font color="#8DA7C2" size="1">You are Here: <a href="city/<?php echo $city_rep; ?>"> <?php echo $first_city_cap; ?> </a> >  <a href="business-dir/<?php echo $city_rep; ?>"> Business <?php echo $c; ?> Directory</a> > Searches for <?php echo $bname." in ".$first_city_cap; ?>  </font>
</div>
