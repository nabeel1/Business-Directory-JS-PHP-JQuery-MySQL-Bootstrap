...
if(@$_REQUEST['p']=="")
{
$title="Search All online ".$first_city_cap." businesses & listings in ".$_SERVER['SERVER_NAME'];	

$keyword="local ".$first_city_cap." directory, ".$first_city_cap." business directories, companies in ".$first_city_cap.", business finding of ".$first_city_cap;

$mdesc="city local is one place to find all best online ".$first_city_cap." businesses, listings and company directories. Search new and latest ".$first_city_cap." business.";

}else
{
$title="Page ".$_REQUEST['p']." | Search All online ".$first_city_cap." businesses & listings in ".$_SERVER['SERVER_NAME'];

$keyword="Page ".$_REQUEST['p'].", local ".$first_city_cap." directory, ".$first_city_cap." business directories, companies in ".$first_city_cap.", business finding of ".$first_city_cap;

$mdesc="Find Page ".$_REQUEST['p']." business of ".$first_city_cap.". city local is one place to find all best online ".$first_city_cap." businesses, listings and company directories. Search new and latest ".$first_city_cap." business.";
}
?>
...
<table width="950px">
<tr>
<td align="left" width="475px"><img src="img/arrow-left-national.gif" /><a href="../index.php"><font color="#FFFFFF" ><b>National Home </b></font></a> 
</td>
...
<div id="header" style="background-color:#ffffff; position:absolute; width:950px; height:2998px; padding:0em; top:32px; left:0px; border-style:solid; border-width:0px;">
...
<li id="business-dir"><a href="<?php echo $city_rep;?>">Business Directory</a></li>
...
<div id="header" style="  position:absolute; width:650px; height:25px; padding:0em; top:46px; left:4px; border-style:solid; border-width:0px; ">
<font color="#8DA7C2">You are Here: <a href="http://<?php echo $_SERVER['SERVER_NAME'];?>">Home</a> > Local City <a href="../city/<?php echo $city_rep; ?>"> <?php echo $first_city_cap; ?> </a> > All Businesses in <?php echo $c ?> Directory</font>
</div>
