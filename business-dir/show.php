...
<tr valign="top">
<td bgcolor="#EBF3F8"><p><font color="#40AB05" size="+1"> <a href="../<?php echo $city_rep;?>/<?php echo $bid;?>">About Us</a></font></p></td>
<td bgcolor="#ffffff"><p><font color="#D4D9DD" size="+1"> <a href="../business-dir/show.php?bid=<?php echo $bid;?>&c=<?php echo $c;?>">Slide Show</a></font></td>
<td bgcolor="#EBF3F8"><p><font color="#D4D9DD" size="+1"> <a href="../business-dir/video.php?bid=<?php echo $bid;?>&c=<?php echo $c;?>">See Video</a></font></p></td>
</tr>
</table>
...
<div id="slideshow" style=" height:315px; width:672px; padding: 0em; border-style:solid; border-width:0px; border-color:#00FF99; position:absolute; left:0px; top:196px;" >
...
while($i<$irows)
{
$pics=mysql_result($ires,$i,"image_url");
echo  "<li><img src='../uploads/$pics' width='636' height='280' /></li>";
$i++;
}
?>	
 </ul>
