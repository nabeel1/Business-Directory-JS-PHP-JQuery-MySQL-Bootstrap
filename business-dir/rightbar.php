<div id="leftbar" style=" height:900px; width:180px; padding: 0em; border-style:solid; border-width:0px; border-color:#B8B8B8; position:absolute; left:4px; top:146px; float:left; background-color:#ffffff;" >
...
echo "<img src='img/article_bullet.png' /><a href='../cities/uk/c/$city_rep/bid/$iid' rel='nofollow'> $ind_name1</a><br />";
echo "<hr>";
$o++;
}
?>
...
<img src="img/bullet1.png" /> <a href="../city/<?php echo $city_rep; ?>" rel="nofollow"><?php echo $first_city_cap; ?> Home</a> <br /> <hr>
<img src="img/bullet1.png" /> <a href="" rel="nofollow"><?php echo $first_city_cap; ?> Business Directory</a> <br /> <hr>
...
<img src="img/bullet1.png" /> <a href="../city/photos/c/<?php echo $city_rep; ?>"> Local <?php echo $first_city_cap; ?> Photos</a> <br /> <hr>
<img src="img/bullet1.png" /> <a href="../city/events/c/<?php echo $city_rep; ?>" rel="nofollow"><?php echo $first_city_cap; ?> Events</a> <br /> <hr>
<img src="img/bullet1.png" /> <a href="../city/property/c/<?php echo $city_rep; ?>" rel="nofollow"><?php echo $first_city_cap; ?> Properties</a> <br /> <hr>
