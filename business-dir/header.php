...
$title="online business directory for ".$c." - ".$_SERVER['SERVER_NAME'];

$keyword="local ".$c.", business directory, business guide ".$c.", online search business.";

$mdesc=$_SERVER['SERVER_NAME']." provides you online business directory for ".$c.". Search & review top businesses, listings and companies in local ".$c." area.";
?>
...
<div id="header" style="background-color:#ffffff; position:absolute; width:950px; height:2626px; padding:0em; top:32px; left:0px; border-style:solid; border-width:0px;">
...
<a style="" href="../allcities.php">Change Location</a> <img src="img/downarrow.gif" />
</div>
...
<font color="#8DA7C2">You are Here: <a href="http://<?php echo $_SERVER['SERVER_NAME'];?>">Home</a> > Local City <a href="../city/<?php echo $city_rep; ?>"> <?php echo $first_city_cap; ?> </a> > Business <?php echo $c ?> Directory</font>
</div>
