...
@$bid=$_REQUEST['bid'];
@$page=$_REQUEST['page'];
@$bid_link=$_REQUEST['bid'];
@$res=mysql_query("SELECT * FROM tblindustries WHERE id='$bid'");
@$id=mysql_result($res,0,"id");
@$cat_name=mysql_result($res,0,"sIndustryName");
@$title=mysql_result($res,0,"mtitle");
@$mdesc=mysql_result($res,0,"mdesc");
@$keyword=mysql_result($res,0,"mkeyword");
@$cdesc=mysql_result($res,0,"pdesc");
@$bid2=mysql_result($res,0,"id");

$temp_title1=explode(' ',$title);
$temp_title2=$temp_title1[count($temp_title1)-1];
?>
<title><?php echo "Page ".$page." | ".$title." in ".$c.",".$c." ".$temp_title1[0].",".$c." ".$temp_title2; ?></title>


<meta name="keywords" content="<?php echo "Page ".$page.", ".$title." in ".$c.",".$c." ".$temp_title1[0].",".$c." ".$temp_title2.",".$c." ".$title.",".$temp_title1[0]." in ".$c.",".$temp_title2." in ".$c; ?>" />
<meta name="description" content="<?php echo "Find ".$title." in ".$c." Page ".$page." city local business directory. Add your ".$c." ".$title." listing freely.".$c." ".$title." directory is fastest growing ".$title." directory for ".$c."." ?>" />

<?php $title="Page ".$page." | ".$title." in ".$c.",".$c." ".$temp_title1[0].",".$c." ".$temp_title2; ?> 
...
<table width="950px">
<tr>
<td align="left" width="475px"><img src="../../../../../../business-dir/img/arrow-left-national.gif" /><a href="../../../../../../index.php"><font color="#FFFFFF" ><b>National Home </b></font></a> 
</td>
...
<div id="header" style="background-color:#ffffff; position:absolute; width:950px; height:2794px; padding:0em; top:32px; left:0px; border-style:solid; border-width:0px;">
...
<img src="../../../../../../business-dir/img/topbanner-pin.png" />
</div>
...
<a style="text-decoration:none;" href="../../../../../../allcities.php"> <img src="../../../../../../business-dir/img/topbanner-changelocation.png" /> </a>
...
<font color="#8DA7C2" size="1">You are Here: <a href="../../../../../city/<?php echo $city_rep; ?>"> <?php echo $first_city_cap; ?> </a> >  <a href="../../../../../business-dir/<?php echo $city_rep; ?>"> Business <?php echo $c ?> Directory</a> > Businesses of <?php echo $cat_name; ?> in <?php echo $c;?> </font>
</div>
