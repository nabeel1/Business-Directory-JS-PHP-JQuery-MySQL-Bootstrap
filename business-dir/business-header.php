...
@$res=mysql_query("SELECT * FROM main_category WHERE category='$b'");
@$id=mysql_result($res,0,"id");

@$title=mysql_result($res,0,"category");
...
?>
<title><?php echo "Online ".$title." in ".$c." directory" ?></title>

<meta name="keywords" content=<?php echo "\"".$c." ".$temp_title1[0].",".$c." ".$temp_title2.",".$c." ".$title.",".$temp_title1[0]." in ".$c.",".$temp_title2." in ".$c; ?>" />

<meta name="description" content="<?php echo "Find online ".$title." in ".$c." directory. Add your best ".$title." business listings in city local ".$c." for free." ?>" />

<?php $title="Online ".$title." in ".$c." directory"  ?>
...
<div id="header" style="background-color:#ffffff; position:absolute; width:950px; height:3858px; padding:0em; top:32px; left:0px; border-style:solid; border-width:0px;">

<!-- Div for header -->

<div id="header" style=" background-image:url(../../../../business-dir/img/Untitled-4.gif); background-repeat:repeat-x; position:absolute; width:950px; height:150px; padding:0em; top:0px; left:0px; border-style:solid; border-width:0px;">
...
<font color="#8DA7C2">You are Here: <a href="../../../../city/<?php echo $city_rep; ?>"> <?php echo $first_city_cap; ?> </a> >  <a href="../../../../business-dir/<?php echo $city_rep; ?>"> Business <?php echo $c ?> Directory</a> > <?php echo $b ?> in <?php echo $c;?> </font>
</div>
