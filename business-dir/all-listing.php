...
<tr>
<td bgcolor="#32A4D5">
<font color="#FFFFFF" size="+1"> <img src="../business-dir/img/book.gif" /> Businesses & Companies <?php echo " in ".$first_city_cap; ?>  </font>
</td>
</tr>
...
$res=mysql_query("SELECT id,sBusinessName,sTelephone,iPaid,dSubStartDate,dSubEndDate,image_url,sAddress,tDescription,iUserId,iIndustry FROM tblbusinesses WHERE iCity='$c_id' ORDER BY id DESC Limit 0,20 ");
...
$res_paging=mysql_query("SELECT count(id) FROM tblbusinesses WHERE iCity='$c_id' ORDER BY id DESC ");
	@$no_rows=mysql_result($res_paging,0,"count(id)");
...
<div align="right" style="background-color:#4AC5E4; width:738px;"> <a class="pagelink" href="all-listing-page.php?c=<?php echo $city_rep; ?>&p=1"> <font size="+1" color="#ffffff">Click Here To See Next Businesses >></font></a> </div>
...
<div align="right" style="background-color:#4AC5E4; width:738px;"> <a class="pagelink" href="all-listing-page.php?c=<?php echo $city_rep; ?>&p=1"> <font size="+1" color="#ffffff">Click Here To See Next Listing's >></font></a> </div>
