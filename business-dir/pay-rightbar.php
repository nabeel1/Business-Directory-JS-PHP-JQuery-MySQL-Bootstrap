...
$resm=mysql_query("SELECT iIndustry, COUNT( iIndustry ) AS cind FROM  `tblbusinesses` WHERE  `iCity` =  '$id' GROUP BY  `iIndustry` ORDER BY cind DESC  LIMIT 0 , 12");
...
<img src="../business-dir/img/bullet1.png" /> <a href="" rel="nofollow"><?php echo $first_city_cap; ?> Business Directory</a> <br /> <hr>
...
<?php
$resm=mysql_query("SELECT category,id,logo FROM main_category ORDER BY count DESC Limit 0,12");
$num_rows_m=MYSQL_NUM_ROWS($resm);
$o=0;
while($o<$num_rows_m)
{
